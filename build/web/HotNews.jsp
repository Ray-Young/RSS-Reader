<%-- 
    Document   : HotNews
    Created on : 2014-4-8, 21:04:49
    Author     : Andy
--%>

<%@page import="java.io.File"%>
<%@page contentType="text/html" pageEncoding="UTF-8" import="news.*"%>
    ...
    <body>
        ...
        <table border="1" >
            ...
            <%
                ...
                HotNews w = new HotNews();
                String path = getServletContext().getRealPath("/");
                w.init();
                w.createXml(path);

                SAXReader reader = new SAXReader();
                Document document = reader.read(new File(path + "/XML/HotNews.xml"));
